      ...
      bengaliTtfId_(0), topIndex_(0)
{
    ...
    uint8_t totalFontId = UIFontInitialization::GetInstance()->GetTotalFontId();
...
{
    if ((fontListId >= UIFontInitialization::GetInstance()->GetTotalFontId()) || (fontIds == nullptr) || (size == 0) ||
...
{
    if ((fontListId >= UIFontInitialization::GetInstance()->GetTotalFontId()) || (fontIds == nullptr) ||
