...
namespace OHOS
{
    ...
    public:
        ...
        //--------------------------------------------------------------------
        GRAPTHIC_INLINE unsigned width()  const { return m_rbuf->width();  }
        GRAPTHIC_INLINE unsigned height() const { return m_rbuf->height(); }
        GRAPTHIC_INLINE int      stride() const { return m_rbuf->stride(); }
