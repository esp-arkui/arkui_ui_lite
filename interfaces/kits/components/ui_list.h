...
private:
    ...
    void FixDistance(int16_t& distanceX, int16_t& distanceY, uint16_t selectPosition) override;
    void FixHorDistance(int16_t& distanceX, uint16_t selectPosition);
    void FixVerDistance(int16_t& distanceY, uint16_t selectPosition);
#if ENABLE_ROTATE_INPUT
