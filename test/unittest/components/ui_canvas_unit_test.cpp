...
HWTEST_F(UICanvasTest, UICanvasSetStartPosition_001, TestSize.Level1)
{
    ...
    canvas_->SetStartPosition(PointValue(POS_X, POS_Y));
...
HWTEST_F(UICanvasTest, UICanvasMoveTo_001, TestSize.Level0)
{
    ...
    canvas_->BeginPath();
    canvas_->MoveTo(PointValue(START1_X, START1_Y));
...
HWTEST_F(UICanvasTest, UICanvasLineTo_001, TestSize.Level0)
{
    ...
    canvas_->BeginPath();
    canvas_->LineTo(PointValue(LINE1_X, LINE1_Y));
    Point start = canvas_->GetStartPos();
...
HWTEST_F(UICanvasTest, UICanvasLineTo_002, TestSize.Level1)
{
    ...
    canvas_->LineTo(PointValue(LINE2_X, LINE2_Y));
...
HWTEST_F(UICanvasTest, UICanvasArcTo_001, TestSize.Level0)
{
    ...
    canvas_->BeginPath();
    canvas_->ArcTo(PointValue(CENTER_X, CENTER_Y), RADIUS, START_ANGLE, END_ANGLE);
...
HWTEST_F(UICanvasTest, UICanvasArcTo_002, TestSize.Level1)
{
    ...
    canvas_->BeginPath();
    canvas_->ArcTo(PointValue(CENTER_X, CENTER_Y), RADIUS, START_ANGLE,
...
HWTEST_F(UICanvasTest, UICanvasAddRect_001, TestSize.Level0)
{
    ...
    canvas_->BeginPath();
    canvas_->AddRect(PointValue(RECT_X, RECT_Y), RECT_HEIGHT, RECT_WIDTH);
...
HWTEST_F(UICanvasTest, UICanvasStrokeRect_001, TestSize.Level1)
{
    ...
    viewGroup->SetWidth(WIDTH);
    viewGroup->SetHeight(HEIGHT);
    canvas_->StrokeRect(PointValue(RECT_X, RECT_Y), RECT_HEIGHT, RECT_WIDTH, paint);
    viewGroup->Add(canvas_);
    ...
    viewGroup->SetWidth(WIDTH);
    viewGroup->SetHeight(HEIGHT);
    canvas_->StrokeRect(PointValue(0, 0), RECT_HEIGHT, RECT_WIDTH, paint);
    viewGroup->Add(canvas_);
...
HWTEST_F(UICanvasTest, UICanvasCleanRect_001, TestSize.Level1)
{
    ...
    canvas_->DrawRect(PointValue(RECT_X, RECT_Y), RECT_HEIGHT, RECT_WIDTH, paint);
    viewGroup->Add(canvas_);
    
    canvas_->ClearRect(PointValue(RECT_X + RECT_X / 2, RECT_Y + RECT_Y / 2),
    ...
    canvas_->ClearRect(PointValue(RECT_X - 10, RECT_Y - 10),
...
HWTEST_F(UICanvasTest, UICanvasDrawImage_001, TestSize.Level1)
{
    ...
    canvas_->DrawImage(PointValue(0, 0), JPEG_IMAGE_PATH, paint);
    viewGroup->Add(canvas_);
    EXPECT_EQ(canvas_->GetStartPosition().x, 0);
    EXPECT_EQ(canvas_->GetStartPosition().y, 0);
    
    canvas_->ClearRect(PointValue(RECT_X + RECT_X / DOUBLENUMBER, RECT_Y + RECT_Y / DOUBLENUMBER),
    ...
    canvas_->DrawImage(PointValue(IMAGE_X, IMAGE_Y), JPEG_IMAGE_PATH, paint);
    viewGroup->Add(canvas_);
...
HWTEST_F(UICanvasTest, UICanvasDrawImage_002, TestSize.Level1)
{
    ...
    canvas_->DrawImage(PointValue(IMAGE_X, IMAGE_Y), PNG_1_PALETTE_IMAGE_PATH, paint);
    viewGroup->Add(canvas_);
    EXPECT_EQ(canvas_->GetStartPosition().x, IMAGE_X);
    EXPECT_EQ(canvas_->GetStartPosition().y, IMAGE_Y);
...
HWTEST_F(UICanvasTest, UICanvasDrawImage_003, TestSize.Level1)
{
    ...
    canvas_->DrawImage(PointValue(IMAGE_X, IMAGE_Y), GIF_IMAGE_PATH1, paint);
    viewGroup->Add(canvas_);
    EXPECT_EQ(canvas_->GetStartPosition().x, IMAGE_X);
    EXPECT_EQ(canvas_->GetStartPosition().y, IMAGE_Y);
...
HWTEST_F(UICanvasTest, UICanvasGlobalAlpha_002, TestSize.Level1)
{
    ...
    paint_->SetFillColor(color);
    canvas_->DrawRect(PointValue(RECT_X, RECT_Y), RECT_WIDTH, RECT_HEIGHT, *paint_);
    paint_->SetStyle(Paint::PaintStyle::FILL_STYLE);
    color = Color::Green();
    paint_->SetFillColor(color);
    paint_->SetGlobalAlpha(GLOBALALPHA);
    canvas_->DrawRect(PointValue(POS_X, POS_Y), WIDTH, HEIGHT, *paint_);
...
HWTEST_F(UICanvasTest, UICanvasSetGlobalCompositeOperation_002, TestSize.Level1)
{
    ...
    canvas_->BeginPath();
    canvas_->MoveTo(PointValue(START1_X, START1_Y));
    canvas_->LineTo(PointValue(START1_X, POS_Y));
    canvas_->LineTo(PointValue(POS_X, POS_Y));
    canvas_->LineTo(PointValue(POS_X, START1_Y));
    canvas_->ClosePath();
    ...
    canvas_->BeginPath();
    canvas_->MoveTo(PointValue(LINE_X, LINE_X));
    canvas_->LineTo(PointValue(LINE_X, LINE_Y));
    canvas_->LineTo(PointValue(LINE_Y, LINE_Y));
    canvas_->LineTo(PointValue(LINE_Y, LINE_X));
    canvas_->ClosePath();
    canvas_->FillPath(*paint_);
...
HWTEST_F(UICanvasTest, UICanvasRestore_002, TestSize.Level1)
{
    ...
    paint_->SetFillColor(color);
    canvas_->Save(*paint_);
    canvas_->DrawRect(PointValue(POS_X, POS_Y), RECT_WIDTH, RECT_HEIGHT, *paint_);
    *paint_ = canvas_->Restore();
    canvas_->DrawRect(PointValue(RECT_X, RECT_Y), WIDTH, HEIGHT, *paint_);
