...
#ifndef GRAPHIC_LITE_UI_AUTO_TEST_MANAGER_H
#define GRAPHIC_LITE_UI_AUTO_TEST_MANAGER_H
...
public:
    ...
    void StartTest(std::vector<std::shared_ptr<OHOS::TestMsgInfo>> msgInfo);
...
#endif  // GRAPHIC_LITE_UI_AUTO_TEST_MANAGER_H
