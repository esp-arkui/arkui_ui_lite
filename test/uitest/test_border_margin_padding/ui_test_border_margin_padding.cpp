...
void UITestBorderMarginPadding::SetUp()
{
    ...
    BorderListtener* borderListtener_ = new BorderListtener(this);
    border_.SetOnChangeListener(borderListtener_);
    MarginListtener* marginListtener_ = new MarginListtener(this);
    margin_.SetOnChangeListener(marginListtener_);
    PaddingListtener* paddingListtener_ = new PaddingListtener(this);
    padding_.SetOnChangeListener(paddingListtener_);
...
{
    if (borderListtener_ != nullptr) {
        delete borderListtener_;
        borderListtener_ = nullptr;
    }
    if (marginListtener_ != nullptr) {
        delete marginListtener_;
        marginListtener_ = nullptr;
    }
    if (paddingListtener_ != nullptr) {
        delete paddingListtener_;
        paddingListtener_ = nullptr;
    }
    if (adapterData_ != nullptr) {
        adapterData_->Clear();
        delete adapterData_;
