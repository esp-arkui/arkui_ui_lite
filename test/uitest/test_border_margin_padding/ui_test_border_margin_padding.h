...
namespace OHOS {
class BorderListtener;
class MarginListtener;
class PaddingListtener;
...
private:
    ...
    MarginListtener* marginListtener_ = nullptr;
    BorderListtener* borderListtener_ = nullptr;
    PaddingListtener* paddingListtener_ = nullptr;
...
class MarginListtener : public UIToggleButton::OnChangeListener {
public:
    explicit MarginListtener(UITestBorderMarginPadding* view)
    {
        view_ = view;
    }

    virtual ~MarginListtener() {}
...
class BorderListtener : public UIToggleButton::OnChangeListener {
public:
    explicit BorderListtener(UITestBorderMarginPadding* view)
    {
        view_ = view;
    }

    virtual ~BorderListtener() {}
...
class PaddingListtener : public UIToggleButton::OnChangeListener {
public:
    explicit PaddingListtener(UITestBorderMarginPadding* view)
    {
        view_ = view;
    }

    virtual ~PaddingListtener() {}
