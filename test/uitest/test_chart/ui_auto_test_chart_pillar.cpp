...
{
    Reset();
    const char* fileName = "ui_test_chart_pillar_add_data_01.bmp";
    CompareByBinary(fileName);
    ClickViewById(UI_TEST_CHART_PILLAR_ADD_DATA_BTN_ID_01);
    const char* fileName2 = "ui_test_chart_pillar_add_data_02.bmp";
    CompareByBinary(fileName2);
    ClickViewById(UI_TEST_CHART_PILLAR_ADD_DATA_BTN_ID_01);
    const char* fileName3 = "ui_test_chart_pillar_add_data_03.bmp";
...
void UIAutoTestChartPillar::UIKitChartPillarTestDeleteDataSerial001() const
{
    ...
    const char* fileName = "ui_test_chart_pillar_del_data_01.bmp";
    CompareByBinary(fileName);
    ClickViewById(UI_TEST_CHART_PILLAR_DEL_DATA_BTN_ID_01);
    const char* fileName2 = "ui_test_chart_pillar_del_data_02.bmp";
    CompareByBinary(fileName2);
    ClickViewById(UI_TEST_CHART_PILLAR_DEL_DATA_BTN_ID_01);
    const char* fileName3 = "ui_test_chart_pillar_del_data_03.bmp";
    CompareByBinary(fileName3);
}
...
void UIAutoTestChartPillar::UIKitChartPillarTestClearDataSerial001() const
{
    ...
    const char* fileName = "ui_test_chart_pillar_clr_data_01.bmp";
    CompareByBinary(fileName);
}
...
void UIAutoTestChartPillar::UIKitChartPillarTestReverse001() const
{
    ...
    const char* fileName = "ui_test_chart_pillar_reverse_01.bmp";
    CompareByBinary(fileName);
}
...
void UIAutoTestChartPillar::UIKitChartPillarTestSetAxisLineColor001() const
{
    ...
    const char* fileName = "ui_test_chart_pillar_axis_color_01.bmp";
    CompareByBinary(fileName);
}
...
void UIAutoTestChartPillar::UIKitChartPillarTestSetAxisLineVisible001() const
{
    ...
    const char* fileName = "ui_test_chart_pillar_axis_visible_01.bmp";
    CompareByBinary(fileName);
}
} // namespace OHOS