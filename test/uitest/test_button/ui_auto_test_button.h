...
public:
     ...
     */
    void UIKitCheckBoxAutoTest001() const;

    /**
     * @brief Auto Test Checkbox's SetImage Function
     */
    void UIKitCheckBoxAutoTest002() const;

    /**
     * @brief Auto Test Radiobutton Function
     */
    void UIKitRadioButtonAutoTest001() const;

    /**
     * @brief Auto Test Radiobutton's SetImage Function
     */
    void UIKitRadioButtonAutoTest002() const;

    /**
     * @brief Auto Test Togglebutton Function
     */
    void UIKitToggleButtonAutoTest001() const;

    /**
     * @brief Auto Test Togglebutton's SetImage Function
     */
    void UIKitToggleButtonAutoTest002() const;

    /**
     * @brief Auto Test button Function
     */
    void UIKitButtonAutoTest001() const;
};
} // namespace OHOS
