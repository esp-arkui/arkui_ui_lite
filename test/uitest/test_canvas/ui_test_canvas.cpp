...
#define RM_009_LINE_CAP_DRAW_PATH_CANVAS_1 \
    canvas->BeginPath(); \
    canvas->MoveTo(PointValue(LINE11_X, LINE13_Y)); /* 竖线 */ \
    canvas->LineTo(PointValue(LINE11_X, LINE11_Y)); \
    canvas->DrawPath(paint); \
    canvas->BeginPath(); \
    canvas->MoveTo(PointValue(LINE11_X, LINE1_Y)); /* 横线 */ \
    canvas->LineTo(PointValue(LINE17_X, LINE1_Y)); \
    canvas->DrawPath(paint); \
    canvas->BeginPath(); \
    canvas->MoveTo(PointValue(LINE26_Y, LINE25_Y)); /* 斜线 */ \
    canvas->LineTo(PointValue(LINE18_X, LINE1_Y)); \
    canvas->DrawPath(paint)

#define RM_009_LINE_CAP_DRAW_PATH_CANVAS_2 \
    canvas->BeginPath(); \
    canvas->MoveTo(PointValue(LINE1_X, LINE13_Y)); /* 竖线 */ \
    canvas->LineTo(PointValue(LINE19_X, LINE11_Y)); \
    canvas->DrawPath(paint); \
    canvas->BeginPath(); \
    canvas->MoveTo(PointValue(LINE11_X, LINE26_X)); /* 横线 */ \
    canvas->LineTo(PointValue(LINE17_X, LINE2_Y)); \
    canvas->DrawPath(paint); \
    canvas->BeginPath(); \
    canvas->MoveTo(PointValue(LINE28_X, LINE25_Y)); /* 斜线 */ \
    canvas->LineTo(PointValue(LINE21_X, LINE1_Y)); \
    canvas->DrawPath(paint)

#define RM_009_LINE_CAP_DRAW_PATH_CANVAS_3 \
    canvas->BeginPath(); \
    canvas->MoveTo(PointValue(LINE22_X, LINE13_Y)); /* 竖线 */ \
    canvas->LineTo(PointValue(LINE22_X, LINE11_Y)); \
    canvas->DrawPath(paint); \
    canvas->BeginPath(); \
    canvas->MoveTo(PointValue(LINE11_X, LINE23_Y)); /* 横线 */ \
    canvas->LineTo(PointValue(LINE17_X, LINE23_Y)); \
    canvas->DrawPath(paint); \
    canvas->BeginPath(); \
    canvas->MoveTo(PointValue(LINE18_X, LINE25_Y)); /* 斜线 */ \
    canvas->LineTo(PointValue(LINE24_X, LINE1_Y)); \
    canvas->DrawPath(paint)

#define RM_008_UI_KIT_CANVAS_SHADOW_TEST_008 \
    ...
    canvas->BeginPath(); \
    canvas->MoveTo(PointValue(LINE11_X, LINE13_Y)); \
    canvas->LineTo(PointValue(LINE11_X, LINE10_Y)); \
    canvas->LineTo(PointValue(LINE2_X, LINE10_Y)); \
    canvas->LineTo(PointValue(LINE2_X, LINE13_Y)); \
    canvas->ClosePath(); \
    canvas->FillPath(paint); \
    paint.SetShadowOffsetX(OFFSETX20); \
    paint.SetShadowOffsetY(OFFSETX10); \
    canvas->BeginPath(); \
    canvas->MoveTo(PointValue(LINE26_X, LINE13_Y)); \
    canvas->LineTo(PointValue(LINE26_X, LINE10_Y)); \
    canvas->LineTo(PointValue(LINE28_X, LINE10_Y)); \
    canvas->LineTo(PointValue(LINE28_X, LINE13_Y)); \
    canvas->ClosePath(); \
    canvas->FillPath(paint); \
    ...
    canvas->BeginPath(); \
    canvas->MoveTo(PointValue(LINE11_X, LINE11_Y)); \
    canvas->LineTo(PointValue(LINE11_X, LINE2_Y)); \
    canvas->LineTo(PointValue(LINE2_X, LINE2_Y)); \
    canvas->LineTo(PointValue(LINE2_X, LINE11_Y)); \
    canvas->ClosePath(); \
    canvas->DrawPath(paint); \
    paint.SetShadowOffsetX(OFFSETX20); \
    paint.SetShadowOffsetY(OFFSETX10); \
    canvas->BeginPath(); \
    canvas->MoveTo(PointValue(LINE26_X, LINE11_Y)); \
    canvas->LineTo(PointValue(LINE26_X, LINE2_Y)); \
    canvas->LineTo(PointValue(LINE28_X, LINE2_Y)); \
    canvas->LineTo(PointValue(LINE28_X, LINE11_Y)); \
    canvas->ClosePath(); \
    canvas->DrawPath(paint); \
    paint.FillStyle(Color::Orange()); \
    ...
    paint.SetShadowOffsetY(OFFSETX10); \
    canvas->BeginPath(); \
    canvas->MoveTo(PointValue(LINE34_X, LINE13_Y)); \
    canvas->LineTo(PointValue(LINE34_X, LINE10_Y)); \
    canvas->LineTo(PointValue(LINE31_X, LINE10_Y)); \
    canvas->LineTo(PointValue(LINE31_X, LINE13_Y)); \
    canvas->ClosePath(); \
    canvas->FillPath(paint); \
    paint.StrokeStyle(Color::Orange()); \
    ...
    paint.SetShadowOffsetY(OFFSETX10); \
    canvas->BeginPath(); \
    canvas->MoveTo(PointValue(LINE34_X, LINE11_Y)); \
    canvas->LineTo(PointValue(LINE34_X, LINE26_X)); \
    canvas->LineTo(PointValue(LINE31_X, LINE26_X)); \
    canvas->LineTo(PointValue(LINE31_X, LINE11_Y)); \
    canvas->ClosePath(); \
    canvas->DrawPath(paint)

#define RM_011_CANVAS_ROTATE_001 \
    UICanvas* canvas = CreateCanvas(); \
    Paint paint; \
    paint.StrokeStyle(Color::Red()); \
    paint.SetStrokeWidth(STROKE3_WIDTH); \
    canvas->BeginPath(); \
    canvas->MoveTo(PointValue(LINE8_X, LINE8_X)); \
    canvas->LineTo(PointValue(LINE6_X, LINE6_Y)); \
    canvas->LineTo(PointValue(LINE6_X, LINE7_Y)); \
    canvas->LineTo(PointValue(LINE8_X, LINE8_Y)); \
    canvas->ClosePath(); \
    canvas->DrawPath(paint); \
    paint.StrokeStyle(Color::Green()); \
    paint.Rotate(ROTATE_ANGLE); \
    canvas->BeginPath(); \
    canvas->MoveTo(PointValue(LINE8_X, LINE6_Y)); \
    canvas->LineTo(PointValue(LINE6_X, LINE6_Y)); \
    canvas->LineTo(PointValue(LINE6_X, LINE7_Y)); \
    canvas->LineTo(PointValue(LINE8_X, LINE7_Y)); \
    canvas->ClosePath(); \
    canvas->DrawPath(paint); \
...
void UITestCanvas::UIKitCanvasTestDrawLine001()
{
    ...
    canvas->DrawLine(PointValue(0, START1_X), PointValue(LINE4_X, START1_X), paint);
}
...
void UITestCanvas::UIKitCanvasTestDrawLine002()
{
    ...
    canvas->SetStartPosition(PointValue(START_X, START_Y)); // {50, 10}: Start point coordinates x, y;
    canvas->DrawLine(PointValue(LINE2_X, RECT_Y), paint);   // {100, 50}: end point coordinates x, y
}
...
void UITestCanvas::UIKitCanvasTestDrawCurve001()
{
    ...
    canvas->DrawCurve(PointValue(LINE2_X, RECT_Y), PointValue(LINE12_X, RECT_Y), PointValue(LINE12_X, RECT_Y),
                      PointValue(LINE12_X, LINE1_Y), paint);
}
...
void UITestCanvas::UIKitCanvasTestDrawCurve002()
{
    ...
    Paint paint;
    paint.SetStrokeColor(Color::Red());
    canvas->DrawCurve(PointValue(LINE2_X, LINE_CURVE_Y), PointValue(LINE12_X, LINE_CURVE_Y),
                      PointValue(LINE12_X, LINE1_Y), paint);
}
...
void UITestCanvas::UIKitCanvasTestDrawRect001()
{
    ...
    canvas->DrawRect(PointValue(LINE1_Y, START1_Y), LINE4_X, TRANSLATE_Y, paint);
}
...
void UITestCanvas::UIKitCanvasTestDrawRect002()
{
    ...
    canvas->DrawRect(PointValue(LINE28_X, START2_Y), LINE4_X, LINE_RECT_Y50, paint);
}
...
void UITestCanvas::UIKitCanvasTestDrawRect003()
{
    ...
    canvas->DrawRect(PointValue(LINE_RECT_X300, LINE_RECT_Y10), LINE_RECT_WIDTH50, LINE_RECT_HEIGHT50, paint);
}
...
void UITestCanvas::UIKitCanvasTestDrawCircle001()
{
    ...
    canvas->DrawCircle(PointValue(LINE_CURVE_X100, LINE_CURVE_Y100), LINE_CURVE_R30, paint);
}
...
void UITestCanvas::UIKitCanvasTestDrawCircle002()
{
    ...
    canvas->DrawCircle(PointValue(LINE_CURVE_X200, LINE_CURVE_Y100), LINE_CURVE_R30, paint);
}
...
void UITestCanvas::UIKitCanvasTestDrawCircle003()
{
    ...
    canvas->DrawCircle(PointValue(LINE_CURVE_X300, LINE_CURVE_Y100), LINE_CURVE_R30, paint);
}
...
void UITestCanvas::UIKitCanvasTestDrawArc001()
{
    ...
    canvas->DrawArc(PointValue(ARC_X100, ARC_Y150), ARC_R50, ARC_ANGLE135, ARC_ANGLE270, paint);
}
...
void UITestCanvas::UIKitCanvasTestDrawImage001()
{
    ...
    canvas->DrawImage(PointValue(0, IMAGE_START60), RED_IMAGE_PATH, paint);
    paint.SetOpacity(OPA_OPAQUE);
    paint.Rotate(ROTATE_20);
    canvas->DrawImage(PointValue(IMAGE_START100, IMAGE_START20), JPEG_IMAGE_PATH, paint);
    canvas->DrawImage(PointValue(0, 0), JPEG_IMAGE_PATH, paint, IMAGE_WIDTH100, IMAGE_HEIGHT100);
#endif
}
...
void UITestCanvas::UIKitCanvasTestDrawLabel001()
{
    ...
    canvas->DrawLabel(PointValue(LABEL_START50, LABEL_START50), "canvas绘制字体", LABEL_WIDTH100, fontStyle, paint);
}
...
void UITestCanvas::UIKitCanvasTestDrawSector001()
{
    ...
    canvas->DrawSector(PointValue(START_X350, START_Y150), ARC_R100, 0, END_ANGLE30, paint);
}
...
void UITestCanvas::UIKitCanvasTestClear001()
{
    ...
    Paint paint;
    // {0, 10}: Start point coordinates x, y; {50, 10}: end point coordinates x, y
    canvas->DrawLine(PointValue(0, START_Y), PointValue(TRANSLATE_X, START_Y), paint);
    canvas->Clear();
}
...
void UITestCanvas::UIKitCanvasTestDrawPath001()
{
    ...
    Paint paint;
    canvas->BeginPath();
    canvas->MoveTo(PointValue(START1_X, START1_Y));
    canvas->ClosePath();
    canvas->DrawPath(paint);
}
...
void UITestCanvas::UIKitCanvasTestDrawPath002()
{
    ...
    Paint paint;
    canvas->BeginPath();
    canvas->LineTo(PointValue(LINE1_X, LINE1_Y));
    canvas->DrawPath(paint);
}
...
void UITestCanvas::UIKitCanvasTestDrawPath003()
{
    ...
    Paint paint;
    canvas->BeginPath();
    canvas->ArcTo(PointValue(CENTER_X, CENTER_Y), RADIUS, START_ANGLE, END_ANGLE);
    canvas->DrawPath(paint);
}
...
void UITestCanvas::UIKitCanvasTestDrawPath004()
{
    ...
    Paint paint;
    canvas->BeginPath();
    canvas->AddRect(PointValue(RECT_X, RECT_Y), RECT_HEIGHT, RECT_WIDTH);
    canvas->DrawPath(paint);
}
...
void UITestCanvas::UIKitCanvasTestDrawPath008()
{
    ...
    canvas->BeginPath();
    canvas->MoveTo(PointValue(START1_X, START1_Y));
    canvas->AddRect(PointValue(RECT_X, RECT_Y), RECT_WIDTH, RECT_HEIGHT);
    canvas->DrawPath(paint);
}
...
void UITestCanvas::UIKitCanvasTestDrawPath010()
{
    ...
    canvas->LineTo(PointValue(LINE1_X, LINE1_Y));
    canvas->LineTo(PointValue(LINE2_X, LINE2_Y));
    canvas->LineTo(PointValue(START1_X, START1_Y));
    canvas->ClosePath();
    canvas->DrawPath(paint);
}
...
void UITestCanvas::UIKitCanvasTestDrawPath011()
{
    ...
    canvas->MoveTo(PointValue(START1_X, START1_Y));
    canvas->LineTo(PointValue(LINE1_X, LINE1_Y));
    canvas->MoveTo(PointValue(START2_X, START2_Y));
    canvas->LineTo(PointValue(LINE2_X, LINE2_Y));
    canvas->DrawPath(paint);
}
...
void UITestCanvas::UIKitCanvasTestDrawPath026()
{
    ...
    canvas->MoveTo(PointValue(START2_X, START2_Y));
    canvas->ArcTo(PointValue(int16_t(CENTER_X + CENTER_X), CENTER_Y), RADIUS, END_ANGLE, START_ANGLE);
...
void UITestCanvas::UIKitCanvasTestDrawPath027()
{
    ...
    canvas->BeginPath();
    canvas->MoveTo(PointValue(START1_X, START1_Y));
    canvas->ArcTo(PointValue(CENTER_X, CENTER_Y),
                  RADIUS, START_ANGLE, START_ANGLE + CIRCLE_IN_DEGREE + QUARTER_IN_DEGREE);
    canvas->ArcTo(PointValue(int16_t(CENTER_X + CENTER_X), CENTER_Y), RADIUS, END_ANGLE,
...
void UITestCanvas::UIKitCanvasTestDrawPath028()
{
    ...
    canvas->BeginPath();
    canvas->MoveTo(PointValue(START1_X, START1_Y));
    canvas->ArcTo(PointValue(CENTER_X, CENTER_Y), RADIUS, START_ANGLE, START_ANGLE + CIRCLE_IN_DEGREE);
...
void UITestCanvas::UIKitCanvasTestDrawPath031()
{
    ...
    canvas->BeginPath();
    canvas->MoveTo(PointValue(START1_X, START1_Y));
    canvas->LineTo(PointValue(int16_t(LINE1_X + HORIZONTAL_RESOLUTION), LINE1_Y));
    canvas->LineTo(PointValue(LINE2_X, LINE2_Y));
    canvas->DrawPath(paint);
}
...
void UITestCanvas::UIKitCanvasTestDrawPath032()
{
    ...
    Paint paint;
    canvas->BeginPath();
    canvas->MoveTo(PointValue(INT16_MAX, INT16_MAX));
    canvas->LineTo(PointValue(0, 0));

    canvas->MoveTo(PointValue(0, 0));
    canvas->LineTo(PointValue(INT16_MAX, INT16_MAX));

    canvas->MoveTo(PointValue(INT16_MIN, INT16_MIN));
    canvas->LineTo(PointValue(0, 0));

    canvas->MoveTo(PointValue(0, 0));
    canvas->LineTo(PointValue(INT16_MIN, INT16_MIN));
    canvas->DrawPath(paint);
}
...
void UITestCanvas::UIKitCanvasTestDrawPath033()
{
    ...
    Paint paint;
    canvas->BeginPath();
    canvas->ArcTo(PointValue(INT16_MAX, INT16_MAX), RADIUS, START_ANGLE, END_ANGLE);
    canvas->DrawPath(paint);

    canvas->BeginPath();
    canvas->ArcTo(PointValue(INT16_MIN, INT16_MIN), RADIUS, START_ANGLE, END_ANGLE);
    paint.SetStrokeColor(Color::Red());
    canvas->DrawPath(paint);

    canvas->BeginPath();
    canvas->ArcTo(PointValue(CENTER_X, CENTER_Y), UINT16_MAX, START_ANGLE, END_ANGLE);
    paint.SetStrokeColor(Color::Yellow());
    canvas->DrawPath(paint);

    canvas->BeginPath();
    canvas->ArcTo(PointValue(int16_t(CENTER_X + CENTER_X), CENTER_Y), RADIUS, INT16_MIN, INT16_MAX);
    paint.SetStrokeColor(Color::Blue());
    canvas->DrawPath(paint);
}
...
void UITestCanvas::UIKitCanvasTestDrawPath034()
{
    ...
    Paint paint;
    canvas->BeginPath();
    canvas->AddRect(PointValue(INT16_MAX, INT16_MAX), RECT_HEIGHT, RECT_WIDTH);
    canvas->DrawPath(paint);

    canvas->BeginPath();
    canvas->AddRect(PointValue(RECT_X, RECT_Y), INT16_MAX, INT16_MAX);
    paint.SetStrokeColor(Color::Red());
    canvas->DrawPath(paint);
}
...
#endif
    RM_009_LINE_CAP_DRAW_PATH_CANVAS_1;

    paint.SetStrokeColor(Color::Red());
#if GRAPHIC_ENABLE_LINECAP_FLAG
    paint.SetLineCap(LineCapEnum::SQUARE_CAP);
#endif
    RM_009_LINE_CAP_DRAW_PATH_CANVAS_2;

    paint.SetStrokeColor(Color::Blue());
#if GRAPHIC_ENABLE_LINECAP_FLAG
    paint.SetLineCap(LineCapEnum::ROUND_CAP);
#endif
    RM_009_LINE_CAP_DRAW_PATH_CANVAS_3;
}
void UITestCanvas::RM009LineJoinDrawPath()
{
    ...
    canvas->MoveTo(PointValue(LINE11_X, LINE13_Y));
    canvas->LineTo(PointValue(LINE11_X, LINE11_Y));
    canvas->LineTo(PointValue(LINE25_X, LINE25_X));
    canvas->LineTo(PointValue(LINE22_X, LINE11_Y));
    canvas->DrawPath(paint);
#if GRAPHIC_ENABLE_LINEJOIN_FLAG
...
#endif
    canvas->BeginPath();
    canvas->MoveTo(PointValue(LINE1_Y, LINE13_Y));
    canvas->LineTo(PointValue(LINE2_X, LINE11_Y));
    canvas->LineTo(PointValue(LINE26_X, LINE25_Y));
    canvas->LineTo(PointValue(LINE27_X, LINE11_Y));
    canvas->DrawPath(paint);
#if GRAPHIC_ENABLE_LINEJOIN_FLAG
    paint.SetLineJoin(LineJoinEnum::MITER_JOIN);
#endif
    canvas->BeginPath();
    canvas->MoveTo(PointValue(LINE14_X, LINE13_Y));
    canvas->LineTo(PointValue(LINE14_X, LINE11_Y));
    canvas->LineTo(PointValue(LINE28_X, LINE25_Y));
    canvas->LineTo(PointValue(LINE29_X, LINE11_Y));
    canvas->DrawPath(paint);
#if GRAPHIC_ENABLE_LINEJOIN_FLAG
    ...
    canvas->BeginPath();
    canvas->MoveTo(PointValue(LINE21_X, LINE13_Y));
    canvas->LineTo(PointValue(LINE21_X, LINE11_Y));
    canvas->LineTo(PointValue(LINE30_X, LINE25_Y));
    canvas->LineTo(PointValue(LINE31_X, LINE25_Y));
    canvas->DrawPath(paint);
}
void UITestCanvas::RM009LineDashDrawPath()
{
    ...
    canvas->BeginPath();
    canvas->MoveTo(PointValue(MOVETO20, MOVETO20));
    canvas->LineTo(PointValue(LINET0200, MOVETO20));
    canvas->LineTo(PointValue(LINET0200, LINET080));
    canvas->LineTo(PointValue(LINET020, LINET080));
    canvas->ClosePath();
    canvas->DrawPath(paint);

    paint.SetLineDashOffset(LINE_DASH_OFFSET5);
    canvas->BeginPath();
    canvas->MoveTo(PointValue(MOVETO20, LINET0120));
    canvas->LineTo(PointValue(LINET0200, LINET0120));
    canvas->LineTo(PointValue(LINET0200, LINET0180));
    canvas->LineTo(PointValue(LINET020, LINET0180));
    canvas->ClosePath();
    canvas->DrawPath(paint);
#endif
}
...
void UITestCanvas::RM009StrokeAndClearRectDrawPath()
{
    ...
    canvas->StrokeRect(PointValue(START1_X, START1_Y), RECT40, RECT50, paint);

    paint.SetFillColor(Color::Red());
    canvas->BeginPath();
    canvas->MoveTo(PointValue(MOVETO30, MOVETO60));
    canvas->LineTo(PointValue(LINET0200, MOVETO60));
    canvas->LineTo(PointValue(LINET0200, LINET0200));
    canvas->LineTo(PointValue(MOVETO30, LINET0200));
    canvas->ClosePath();
    canvas->FillPath(paint);

    canvas->ClearRect(PointValue(RECT50, RECT80), RECT100, RECT70);
}
...
void UITestCanvas::RM008UIKitCanvasTest001()
{
    ...
    canvas->MoveTo(PointValue(LINE11_X, LINE13_Y));
    canvas->LineTo(PointValue(LINE22_X, LINE11_Y));
    canvas->LineTo(PointValue(LINE26_X, LINE13_Y));
    canvas->ArcTo(PointValue(LINE26_X, LINE1_Y), ARC_RADIUS, START1_ANGLE, END1_ANGLE);
    canvas->LineTo(PointValue(LINE26_X, LINE26_Y));
    canvas->LineTo(PointValue(LINE4_X, LINE2_Y));
    canvas->LineTo(PointValue(LINE11_X, LINE27_Y));
    canvas->LineTo(PointValue(LINE3_X, LINE11_Y));
    canvas->ClosePath();
    canvas->FillPath(paint);
    canvas->DrawPath(paint);
}
...
void UITestCanvas::RM008UIKitCanvasTest002()
{
    ...
    canvas->MoveTo(PointValue(LINE9_X, LINE13_Y));
    canvas->LineTo(PointValue(LINE32_X, LINE11_Y));
    canvas->LineTo(PointValue(LINE31_X, LINE13_Y));
    canvas->ArcTo(PointValue(LINE31_X, LINE1_Y), ARC_RADIUS, START1_ANGLE, END1_ANGLE);
    canvas->LineTo(PointValue(LINE31_X, LINE26_Y));
    canvas->LineTo(PointValue(LINE21_X, LINE2_Y));
    canvas->LineTo(PointValue(LINE9_X, LINE27_Y));
    canvas->LineTo(PointValue(LINE33_X, LINE11_Y));
    canvas->ClosePath();
    canvas->FillPath(paint);
}
...
void UITestCanvas::RM008UIKitCanvasTest006()
{
    ...
    canvas->BeginPath();
    canvas->MoveTo(PointValue(LINE11_X, LINE11_Y));
    canvas->LineTo(PointValue(LINE11_X, LINE26_Y));
    canvas->LineTo(PointValue(LINE28_X, LINE26_Y));
    canvas->LineTo(PointValue(LINE28_X, LINE11_Y));
    canvas->ClosePath();
    canvas->FillPath(paint);
}
...
void UITestCanvas::RM008UIKitCanvasShadowTest008()
{
    ...
    RM_008_UI_KIT_CANVAS_SHADOW_TEST_008;
#endif
}
...
void UITestCanvas::RM011StrokeText001()
{
    ...
    Paint paint;
    paint.SetFillColor(Color::Blue());
    canvas->StrokeText("葡萄牙语：Hongmeng, teste", PointValue(0, HEIGHT_Y20), fontStyle, paint);
    canvas->StrokeText("西班牙语：Hong Meng, test", PointValue(0, HEIGHT_Y40), fontStyle, paint);
    canvas->StrokeText("法语：HongMeng, test", PointValue(0, HEIGHT_Y60), fontStyle, paint);
    canvas->StrokeText("瓜拉尼语：mitapoañda, pens", PointValue(0, HEIGHT_Y80), fontStyle, paint);
    canvas->StrokeText("荷兰语：Hongmeng, kom op.", PointValue(0, HEIGHT_Y100), fontStyle, paint);
    canvas->StrokeText("樊瓦什语：Кайалла", PointValue(0, HEIGHT_Y120), fontStyle, paint);
    canvas->StrokeText("白俄罗斯语：Прывітанне", PointValue(0, HEIGHT_Y140), fontStyle, paint);
    canvas->StrokeText("希腊语：Γεια.", PointValue(0, HEIGHT_Y160), fontStyle, paint);
    canvas->StrokeText("瑞典语:Hej, Hongmeng.", PointValue(0, HEIGHT_Y180), fontStyle, paint);
    canvas->StrokeText("俄语: Привет, hongmon ", PointValue(0, HEIGHT_Y200), fontStyle, paint);
    paint.Scale(SCALE1_X, SCALE1_Y);
    paint.Rotate(ROTATE45);
    canvas->StrokeText("中国 你好，鸿蒙。。", PointValue(HEIGHT_Y20, 0), fontStyle, paint);
#endif
}
...
void UITestCanvas::RM011CanvasScale001()
{
    ...
    canvas->BeginPath();
    canvas->MoveTo(PointValue(MOVETO5, MOVETO5));
    canvas->LineTo(PointValue(LINET050, MOVETO5));
    canvas->LineTo(PointValue(LINET050, LINET035));
    canvas->LineTo(PointValue(MOVETO5, LINET035));
    canvas->ClosePath();
    canvas->DrawPath(paint);
    paint.StrokeStyle(Color::Green());
    ...
    canvas->LineTo(PointValue(LINET050, MOVETO5));
    canvas->LineTo(PointValue(LINET050, LINET035));
    canvas->LineTo(PointValue(LINE3_X, LINE3_Y));
    canvas->ClosePath();
    canvas->DrawPath(paint);
    paint.StrokeStyle(Color::Blue());
    paint.SetGlobalAlpha(GLOBALALPHA5);
    ...
    canvas->BeginPath();
    canvas->MoveTo(PointValue(LINE3_X, LINE4_Y));
    canvas->LineTo(PointValue(LINE4_X, LINE4_Y));
    canvas->LineTo(PointValue(LINE4_X, LINE3_Y));
    canvas->LineTo(PointValue(LINE3_X, LINE3_Y));
    canvas->ClosePath();
    canvas->DrawPath(paint);
}
...
void UITestCanvas::RM012globalAlpha001()
{
    ...
    canvas->MoveTo(PointValue(LINE11_X, LINE13_Y));
    canvas->LineTo(PointValue(LINE11_X, LINE11_Y));
    canvas->LineTo(PointValue(LINE12_X, LINE11_Y));
    canvas->LineTo(PointValue(LINE12_X, LINE13_Y));
    canvas->ClosePath();
    canvas->FillPath(paint);
    ...
    canvas->BeginPath();
    canvas->MoveTo(PointValue(LINE1_Y, LINE10_Y));
    canvas->LineTo(PointValue(LINE2_X, LINE2_Y));
    canvas->LineTo(PointValue(LINE9_X, LINE2_Y));
    canvas->LineTo(PointValue(LINE9_X, LINE10_Y));
    canvas->ClosePath();
    canvas->FillPath(paint);

    paint.SetFillColor(Color::Blue());
    canvas->BeginPath();
    canvas->MoveTo(PointValue(LINE14_X, LINE1_Y));
    canvas->LineTo(PointValue(LINE14_X, LINE14_Y));
    canvas->LineTo(PointValue(LINE15_X, LINE14_Y));
    canvas->LineTo(PointValue(LINE15_X, LINE1_Y));
    canvas->ClosePath();
    canvas->FillPath(paint);
}
