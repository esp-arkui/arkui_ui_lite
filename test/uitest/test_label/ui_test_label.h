...
constexpr char* UI_TEST_LABEL_DYNAMIC_WIDTH_BTN_ID_01 = "test_label_dynacamic_width_button_01";
}
...
public:
    ...
    void UIKitUILabelTestDisplay002();
    void UIKitUILabelTestDisplay003();
